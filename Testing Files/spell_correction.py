...
# from deepspeech import char_map
char_map_str = """
<SPACE> 0
ا 1
آ 2
...
def get_model():
    ...
    if MODEL is None:
        ...
        MODEL = kenlm.Model('/home/saad/Documents/Saad-Majid-Project/Language Model Files/Final_LM_Jargon_Wordnet.arpa')
    return MODEL
...
MODEL = None
# Load known word set
with open('/home/saad/Documents/Saad-Majid-Project/Language Model Files/final_lm_cleaned3.txt',encoding='utf-8') as f:
